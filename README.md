# observer
usage: 
``observer.py [-h] --lat LAT --lon LON [--elevation-m ELEVATION_M] [--regime {ALL,LEO,MEO,GEO,HEO}] [--date DATE] [--start-date START_DATE] [--end-date END_DATE] [--time-window TIME_WINDOW] [--start-datetime START_DATETIME]
