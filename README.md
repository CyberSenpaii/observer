# observer
usage: observer.py [-h] --lat LAT --lon LON [--elevation-m ELEVATION_M] [--regime {ALL,LEO,MEO,GEO,HEO}] [--date DATE] [--start-date START_DATE] [--end-date END_DATE] [--time-window TIME_WINDOW] [--start-datetime START_DATETIME]
                   [--period PERIOD] [--min-elevation-deg MIN_ELEVATION_DEG] [--limit LIMIT] [--output {text,json,both}] [--local-offset-hours LOCAL_OFFSET_HOURS] [--exclude-debris] [--include-name INCLUDE_NAME]
                   [--exclude-name EXCLUDE_NAME] [--satellite SATELLITE] [--all-passes] [--match-mode {overlap,aos}] [--identity IDENTITY] [--password PASSWORD]
observer.py: error: the following arguments are required: --lat, --lon
# Satellite discovery
